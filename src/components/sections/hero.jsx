                    ...
                    <div className="col-lg-4">
                        <SlideUp>
                            <div className="about-image-part">
                                ...
                                <h2>Tafazzul Affan</h2>
                                <p>I am a Web Developer base in Indonesia.</p>
                    ...
                    <div className="col-lg-8">
                        <SlideUp>
                            <div className="about-content-part">
                                <p>Hello There!</p>
                                <h2>
                                    I'm Tafazzul Affan, a web developer building seamless web experiences with precision and purpose.
                                </h2>
                                ...
                                <div className="hero-btns">
                                    <Link href="/contact" className="theme-btn download-cv-btn" style={{ backgroundColor: '#096970', borderColor: '#096970' }}>Download CV <i><RiDownloadLine size={16} /></i> </Link>
                                </div>
                            </div>
                        </SlideUp>
                        <SlideUp>
